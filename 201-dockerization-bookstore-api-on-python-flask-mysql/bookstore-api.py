...
app.config['MYSQL_DATABASE_HOST'] = 'database' # database= container name
...
# Write a function named `home` which returns 'Welcome to the yıldıray's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to yıldıray's Bookstore API Service"
